...
public class OrangeFlowerLeavesBlock extends AcerolaFlowerLeavesBlock {
    public static final Item FRUIT_ITEM = ModItems.ORANGE;
    public OrangeFlowerLeavesBlock(Settings settings) {
        super(settings);
    }
    @Override

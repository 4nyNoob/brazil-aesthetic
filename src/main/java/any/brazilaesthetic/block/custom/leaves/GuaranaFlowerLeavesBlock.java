...
public class GuaranaFlowerLeavesBlock extends AcerolaFlowerLeavesBlock {
    public static final Item FRUIT_ITEM = ModItems.GUARANA;
    public GuaranaFlowerLeavesBlock(Settings settings) {
        super(settings);
    }
    @Override

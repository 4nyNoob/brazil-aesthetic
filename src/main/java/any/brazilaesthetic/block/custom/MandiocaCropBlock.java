...
public class MandiocaCropBlock extends CropBlock {
    ...
    private static final VoxelShape[] AGE_TO_SHAPE = new VoxelShape[]{
            ...
            Block.createCuboidShape(0.0, 0.0, 0.0, 16.0, 16.0, 16.0)	//AGE 8
    };
    //AGE PROPERTY
    public static final IntProperty AGE = IntProperty.of("age", 0 , 8);

    public MandiocaCropBlock(Settings settings) {
        super(settings);
    }
